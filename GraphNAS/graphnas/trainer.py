...
class Trainer(object):
    ...
    def train(self):
        ...
        if self.args.derive_finally:
            self.best_actions = self.derive()
            print("best structure:" + str(self.best_actions))
        self.save_model()
    ...
    def derive_from_history(self):
        ...
        self.best_actions = best_structure
    ...
    def get_best_gnn(self, actions=None):
